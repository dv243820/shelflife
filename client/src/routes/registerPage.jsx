    ...
    return (
        <div className="flex flex-col h-[calc(100vh-5.0rem)] items-center justify-center bg-gradient-to-r from-neutral-900/30 via-[#2b241b]/30 to-neutral-900/30">
            <div className="bg-white/75 p-8 rounded-lg shadow-lg w-full max-w-sm overflow-hidden">
                <h1 className="text-2xl font-bold text-center mb-6 text-gray-800 amaranth-bold">Create an Account</h1>
                    ...
                    <div className="">
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                required
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#9a7e5b] mb-2"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                required
                                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-1 ${formData.confirmPassword && formData.password !== formData.confirmPassword
